package eu.asgardschmiede.securedemo.controller;


import eu.asgardschmiede.securedemo.model.Token;
import eu.asgardschmiede.securedemo.model.User;
import eu.asgardschmiede.securedemo.model.UserDto;
...
import eu.asgardschmiede.securedemo.service.CustomEmailService;
...
public class MainController {
    ...
    @PostMapping("forgot")
    public String sendForgotEmail(UserDto userDto, Model model){
